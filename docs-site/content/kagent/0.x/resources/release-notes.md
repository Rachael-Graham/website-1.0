...
{{< tabs >}}
{{< tab name="Old ToolServer (v1alpha1)" >}}
Old ToolServer API:
  ```yaml
  apiVersion: kagent.dev/v1alpha2
  kind: ToolServer
  ...
  ```
{{< /tab >}}
{{< tab name="New RemoteMCPServer (v1alpha2)" >}}
