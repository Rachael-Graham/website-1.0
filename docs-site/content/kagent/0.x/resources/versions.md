...
<!--TODO
This page should be updated whenever `KIND_IMAGE_VERSION` changes in the kagent Makefile. The value is sourced from `docs-site/assets/kagent-docs/versions/max-kube.md`.
-->
